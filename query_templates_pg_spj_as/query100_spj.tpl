...
select min(item1.i_item_sk) as min_item1_i_item_sk,
    min(item2.i_item_sk) as min_item2_i_item_sk,
    min(s1.ss_ticket_number) as min_s1_ss_ticket_number,
    min(s1.ss_item_sk) as min_s1_ss_item_sk
FROM item AS item1,
item AS item2,
store_sales AS s1,
store_sales AS s2,
