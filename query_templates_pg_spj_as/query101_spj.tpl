...
select min(c_customer_sk) as min_c_customer_sk, min(ss_item_sk) as min_ss_item_sk, min(sr_ticket_number) as min_sr_ticket_number, min(ws_order_number) as min_ws_order_number
FROM
store_sales,
store_returns,
web_sales,
